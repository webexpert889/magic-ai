	...
	<section class="site-section pb-20 pt-32 md:opacity-0 md:translate-y-8 transition-all duration-700 [&.lqd-is-in-view]:opacity-100 [&.lqd-is-in-view]:translate-y-0">
		<div class="container">
			<div class="border rounded-[50px] p-20 max-xl:px-10 max-lg:py-12 max-sm:px-5">
				{{getGoogleAd(\App\Enums\HeaderEnum::LANDING_HEADER_SECTION->value)}}
			</div>
		</div>
	</section>
</section>
...
<section id="features">
	...
	<section id="header-ad">
		<section class="site-section pb-20 pt-32 md:opacity-0 md:translate-y-8 transition-all duration-700 [&.lqd-is-in-view]:opacity-100 [&.lqd-is-in-view]:translate-y-0">
			<div class="container">
				<div class="border rounded-[50px] p-20 max-xl:px-10 max-lg:py-12 max-sm:px-5">
					{{getGoogleAd(\App\Enums\HeaderEnum::LANDING_FEATURES_SECTION_728X90->value)}}
				</div>
			</div>
		</section>
	</section>
...
<section id="header-ad">
	<section class="site-section pb-20 pt-32 md:opacity-0 md:translate-y-8 transition-all duration-700 [&.lqd-is-in-view]:opacity-100 [&.lqd-is-in-view]:translate-y-0">
		<div class="container">
			<div class="border rounded-[50px] p-20 max-xl:px-10 max-lg:py-12 max-sm:px-5">
				{{getGoogleAd(\App\Enums\HeaderEnum::LANDING_TOOLS_SECTION_728X90->value)}}
			</div>
		</div>
	</section>
</section>
...
<section id="floating-ad" class="fixed bottom-0 z-50 w-100">
	<section class="site-section pb-20 pt-32 md:opacity-0 md:translate-y-8 transition-all duration-700 [&.lqd-is-in-view]:opacity-100 [&.lqd-is-in-view]:translate-y-0">
		<div class="container">
			{{getGoogleAd(\App\Enums\HeaderEnum::LANDING_TEMPLATES_SECTION_728X90->value)}}
		</div>
	</section>
</section>
