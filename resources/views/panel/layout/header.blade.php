            ...
            <div class="collapse navbar-collapse" id="navbar-menu">
                <ul class="primary-nav navbar-nav max-lg:py-4 max-lg:px-3">
                    ...
                    @if(Auth::user()->type == 'admin')
						...
						<li class="nav-item">
                            <a class="nav-link {{activeRoute('dashboard.admin.adsense.index')}}" href="{{route('dashboard.admin.adsense.index')}}" >
								<span class="nav-link-icon">
									<svg class="svgads" width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
										<path d="M10.8099 11.2264H15.2032C15.2032 13.6527 13.2363 15.6196 10.8099 15.6196C8.3836 15.6196 6.41669 13.6527 6.41669 11.2264C6.41669 8.8001 8.3836 6.83318 10.8099 6.83318C12.0231 6.83318 13.1213 7.32482 13.9163 8.1199M20.4141 11C20.4141 16.1993 16.1993 20.4141 11 20.4141C5.80074 20.4141 1.58594 16.1993 1.58594 11C1.58594 5.8007 5.80074 1.58594 11 1.58594C16.1993 1.58594 20.4141 5.8007 20.4141 11Z"></path></svg>
								</span>
                                <span class="flex items-center transition-[opacity,transform] nav-link-title grow">
									{{__('Google Adsense')}}
								</span>
